          ...
          <div class="flex-1 w-full flex flex-col justify-between"> <!-- 左側區域 -->
            ...
            <template v-if="store.sdict.id"> <!-- 如果有選字典 -->
              ...
              <div class="flex items-center mt-4 gap-4"> <!-- 操作按鈕區 -->
                ...
                <PopConfirm :disabled="!isSaveData" title="目前存在未完成的學習任務，修改會重新生成學習任務，是否繼續？"
          ...
          <div class="flex-1 w-full transition-opacity duration-200"
            ...
            <div class="flex justify-between"> <!-- 任務標題區 -->
              <div class="flex items-center"> <!-- 左側標題 -->
                <div class="p-2 flex justify-center items-center rounded-full"> <!-- 圖示背景 -->
              ...
              <div class="flex gap-1 items-center" v-if="store.sdict.id"> <!-- 右側目標設定 -->
                ...
                <div style="color:#ac6ed1;"
                  class="bg-purple-100 px-1 h-9 flex justify-center items-center text-2xl rounded">
                  <!-- 目標數字 -->
                  {{ store.sdict.id ? store.sdict.perDayStudyNumber : 0 }}
                </div>
                個單字
                <PopConfirm :disabled="!isSaveData" title="目前存在未完成的學習任務，修改會重新產生學習任務，是否繼續？"
                  @confirm="check(() => showPracticeSettingDialog = true)">
                  <Button severity="info" size="small">更改</Button>
                </PopConfirm>
              </div>
            </div>
            <div class="flex mt-4 justify-between border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              <!-- 任務統計 -->
              <div class="stat"> <!-- 新詞統計 -->
